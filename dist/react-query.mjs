...
function mutationReducer$1(state, action) {
  ...
  switch (action.type) {
    ...
    case ActionType$2.Loading:
      return {
        keyed: _extends({}, state.keyed, (_extends2 = {}, _extends2[action._key] = _extends({}, getStatusProps(QueryStatus.Loading), {
          data: undefined,
          error: null
        }), _extends2))
      };
    ...
    case ActionType$2.Resolve:
      return {
        keyed: _extends({}, state.keyed, (_extends3 = {}, _extends3[action._key] = _extends({}, getStatusProps(QueryStatus.Success), {
          data: action.data,
          error: null
        }), _extends3))
      };
    ...
    case ActionType$2.Reject:
      return {
        keyed: _extends({}, state.keyed, (_extends4 = {}, _extends4[action._key] = _extends({}, getStatusProps(QueryStatus.Error), {
          data: undefined,
          error: action.error
        }), _extends4))
      };
...
export { QueryStatus, ReactQueryCacheProvider, ReactQueryConfigProvider, deepIncludes, makeQueryCache, queryCache, queryCaches, setConsole, setFocusHandler, stableStringify, useInfiniteQuery, useIsFetching, useKeyedMutation, useMutation, usePaginatedQuery, useQuery, useQueryCache };
